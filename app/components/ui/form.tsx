...
const useFormField = () => {
  ...
  return {
    ...
    formMessageId: id ? `${id}-form-message` : `${fieldContext.name}-form-message`,
    formDescriptionId: id ? `${id}-form-description` : `${fieldContext.name}-form-description`,
    ...fieldState,
  };
};
...
>(props: ControllerProps<TFieldValues, TName>) {
  ...
  return (
    <FormFieldContext.Provider value={{ name }}>
      <Controller name={name} control={control ?? methods.control} {...rest} />
