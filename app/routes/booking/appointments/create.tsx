...
//                                   if (contact.mobileNumber?.value) parts.push(contact.mobileNumber.value);
//                                   return parts.join(' • ');
//                                 })()
...
//                             </p>
//                             {selectedContact.mobileNumber?.value && (
//                               <p className="text-[11px] text-slate-500">{selectedContact.mobileNumber.value}</p>
//                             )}
//                           </div>
//                         ) : null}
//                       </div>
