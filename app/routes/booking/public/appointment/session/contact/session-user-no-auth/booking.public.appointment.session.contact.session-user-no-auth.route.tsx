...
import type { Route } from './+types/booking.public.appointment.session.contact.session-user-no-auth.route';
...
export default function BookingPublicAppointmentSessionContactSessionUserNoAuthRoute() {
  const loaderData = useLoaderData<typeof loader>();
  const sessionUser = loaderData.sessionUser?.userDto;
