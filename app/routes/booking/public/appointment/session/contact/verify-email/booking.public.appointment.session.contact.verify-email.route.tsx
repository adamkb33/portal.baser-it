...
import { data, Link, redirect, useFetcher, useLoaderData, useLocation, useNavigate } from 'react-router';
...
export default function BookingContactVerifyEmailPage({ loaderData }: Route.ComponentProps) {
