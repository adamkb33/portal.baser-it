...
- Provide a simple bottom action bar for the public booking route flow.
...
- Token usage must stay compatible with booking theme remapping (`BOOKING_THEME_TOKENS`).
