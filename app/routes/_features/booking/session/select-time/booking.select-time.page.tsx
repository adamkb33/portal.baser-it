import { useLoaderData, useNavigation, useSearchParams, useSubmit } from 'react-router';
...
import type { createBookingSelectTimeLoader } from './booking.select-time.loader';
...
export function BookingSelectTimePage() {
  const loaderData = useLoaderData<ReturnType<typeof createBookingSelectTimeLoader>>();
              ...
              <div className="space-y-2">
                {visibleSchedules.map((schedule) => (
                  <DateButton
                    ...
                    hasSelectedTime={schedule.timeSlots.some((slot) => (displayTime ? isSameSlotTime(slot.startTime, displayTime) : false))}
                    onClick={() => {
      ...
      <BookingBottomActionBar
        ...
        actions={[
          ...
          },
          {
            ...
            disabled: !displayTime || isSubmitting,
          },
        ]}
        compact
      />
