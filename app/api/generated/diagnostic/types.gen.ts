...
export type PublicAppointmentCancellationByTokenData = {
    ...
    query?: {
        ...
        eventType?: 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_BLANK' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_MALFORMED' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_SIGNATURE_INVALID' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_PAYLOAD_INVALID' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_EXPIRED' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_APPOINTMENT_NOT_FOUND' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_PROFILE_NOT_FOUND' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_PROVIDER_LOOKUP_FAILED' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_NOTIFICATION_FAILED' | 'PUBLIC_APPOINTMENT_CANCELLATION_BY_TOKEN_FAILED';
        tokenHash?: string;
        from?: string;
        to?: string;
        sort?: string;
...
export type PublicAppointmentCancellationByTokenResponses = {
    /**
     * OK
     */
    200: ApiResponseDiagnosticTableResponseDto;
};

export type PublicAppointmentCancellationByTokenResponse = PublicAppointmentCancellationByTokenResponses[keyof PublicAppointmentCancellationByTokenResponses];
...
export type FlowsResponses = {
    /**
     * OK
     */
    200: ApiResponseDiagnosticServiceFlowsResponseDto;
};

export type FlowsResponse = FlowsResponses[keyof FlowsResponses];
